                        ...
                        <div class="row gap-3">
                            ...
                            <div class="col-12 mt-3">
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" id="tampilkan_semua_invoice"
                                        wire:model.change="tampilkan_semua_invoice">
                                    <label class="form-check-label" for="tampilkan_semua_invoice">
