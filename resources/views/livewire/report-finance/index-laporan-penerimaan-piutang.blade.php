            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form wire:submit="export_to_excel">
                        <div class="row gap-3">
                            <div class="col-12">
                                <label for="type_pembayaran" class="form-label">Tipe Pembayaran</label>
                                <select name="type_pembayaran" id="type_pembayaran"
                                    class="form-select @error('type_pembayaran') is-invalid @enderror"
                                    wire:model="type_pembayaran">
                            ...
                            <div class="col-12">
                                ...
                                <input type="date" class="form-control @error('from_date') is-invalid @enderror"
                                    name="from_date" id="from_date" wire:model="from_date" @disabled($tampilkan_semua_invoice)>
                            ...
                            <div class="col-12">
                                ...
                                <input type="date" class="form-control @error('to_date') is-invalid @enderror"
                                    name="to_date" id="to_date" wire:model="to_date" @disabled($tampilkan_semua_invoice)>
