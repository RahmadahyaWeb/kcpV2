...
class CustomerPaymentDummyController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'headers.*.no_piutang'                  => 'required|string|unique:customer_payment_header_dummy,no_piutang',
        ...
        try {
            foreach ($validated['headers'] as $header) {
                ...
                DB::table('customer_payment_header_dummy')->insert($headerData);
                ...
                foreach ($header['details'] as $detail) {
                    ...
                    DB::table('customer_payment_details_dummy')->insert($detail);
                }
            }
